	...
	<div class="panel-body">
		<form id="f-add" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input id="i-jql" type="text" class="form-control" name="i-jql"  placeholder="JQL">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Jira User</label>
				<div class="col-sm-10">
					<input id="i-user" type="text" class="form-control" name="i-user"  placeholder="Jira User">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Jira Password</label>
				<div class="col-sm-10">
					<input id="i-pwd" type="text" class="form-control" name="i-pwd"  placeholder="Jira Password">
				</div>
			</div>
			<div class="form-group">
