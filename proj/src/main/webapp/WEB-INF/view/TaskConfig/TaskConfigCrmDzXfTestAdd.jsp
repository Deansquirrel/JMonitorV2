	...
	<div class="panel-body">
		<form id="f-add" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input id="i-address" type="text" class="form-control" name="i-address"  placeholder="Address">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">PassportType</label>
				<div class="col-sm-10">
					<input id="i-passporttype" type="text" class="form-control" name="i-passporttype"  placeholder="PassportType">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Passport</label>
				<div class="col-sm-10">
					<input id="i-passport" type="text" class="form-control" name="i-passport"  placeholder="Passport">
				</div>
			</div>
