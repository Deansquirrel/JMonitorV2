	...
	<div class="panel-body">
		<form class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<label class="col-sm-10 control-label" style="text-align: left;">${config.address }</label>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">PassportType</label>
				<label class="col-sm-10 control-label" style="text-align: left;">${config.passportType }</label>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Passport</label>
				<label class="col-sm-10 control-label" style="text-align: left;">${config.passport }</label>
			</div>
			<div class="form-group">
